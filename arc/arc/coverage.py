...
def wsc(X, y, S, delta=0.1, M=1000, random_state=2020, verbose=False):
    ...
    def wsc_v(X, y, S, delta, v):
        ...
        # je change ici pour eviter: index 62 is out of bounds for axis 0 with size 62 ;
        # error dans return cover_min, z_sorted[ai_best], z_sorted[bi_best]
        ...
        for ai in np.arange(0, ai_max):
            ...
            #print("aibest",ai_best)
            #print("bibest",bi_best)
